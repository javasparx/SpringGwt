...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see uz.javlon.service.impl.PasswordTokenManager#generateRecoveryToken(uz.javlon.model.User)
     */
    @Override
    ...
    /**
     * @see uz.javlon.service.impl.PasswordTokenManager#isRecoveryTokenValid(uz.javlon.model.User, java.lang.String)
     */
    @Override
